...
"""
Plugin to send FMS-, ZVEI- and POCSAG-messages via Telegram1
@author: Peter Laemmle
@requires: Telegram1 BOT token, Telegram1 chat ID, library python-telegram-bot and optional requests and json
"""
	...
	try:
		...
		try:
			if typ in ("POC", "FMS", "ZVEI"):
				...
				text = globalVars.config.get("Telegram1", "%s_message" % typ)
